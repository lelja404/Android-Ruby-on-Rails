...
function focus_thumbnail(id)
{
	document.getElementById(id).className = "thumbnail_box_hover"
}
function blur_thumbnail(id)
{
	document.getElementById(id).className = "thumbnail_box"
}
